...
pub fn rank_strategies_for_interval(
    ...
    let mut results: Vec<(String, CompositeScore)> = ALL_STRATEGY_NAMES.iter().map(|&name| {
        let strat = crate::robot::robotic_loop::make_strategy_pub(name);
...
impl HyperOptimizer {
    pub fn optimize<S: crate::strategies::Strategy>(strategy: &S, candles: &[crate::types::Candle], param_grid: &[StrategyParams]) -> StrategyParams {
    ...
    pub fn simulate_score<S: crate::strategies::Strategy>(strategy: &S, candles: &[crate::types::Candle], params: &StrategyParams) -> f64 {
        Self::composite_score_impl(strategy as &dyn crate::strategies::Strategy, candles, params, None)
    }

    /// Trait object versiyonu — robotic_loop param grid + HTF için.
    pub fn simulate_score_dyn(strategy: &dyn crate::strategies::Strategy, candles: &[crate::types::Candle], params: &StrategyParams) -> f64 {
        Self::composite_score_impl(strategy, candles, params, None)
    }

    /// HTF candle'larıyla birlikte composite skor hesabı.
    pub fn simulate_score_htf(strategy: &dyn crate::strategies::Strategy, candles: &[crate::types::Candle], params: &StrategyParams, htf: Option<&[crate::types::Candle]>) -> f64 {
...
use crate::robot::hyperopt::HyperOptResult;
